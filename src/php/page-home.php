    ...
    <div class="wrapper">
        ...
        <section id="cert" class="section section--cert">
            ...
            <div class="section__content">
                ...
                <p class="section-text">Работы проводятся в&nbsp;строгом соответствии c&nbsp;<a href="<?php bloginfo('stylesheet_directory'); ?>/regulations.pdf">регламентом организации</a>,
        ...
        <section id="team" class="section section--experts">
            ...
            <div class="section__content">
                ...
                <article class="expert">
                    <p class="expert__name">Слободнюк Сергей Александрович</p>
                    <p class="expert__profi">направление деятельности:</p>
                    <p class="expert__skill"> «Теплогазоснабжение, водоснабжение, водоотведение, канализация, вентиляция и кондиционирование»</p>
                    <p class="expert__attestat">аттестат №МС-Э-54-10-12530, <br>срок окончания — 15.09.2022</p>
                </article>
                <article class="expert">
                    <p class="expert__name">Хазипова Кристина Геннадьевна</p>
                    <p class="expert__profi">направление деятельности:</p>
                    <p class="expert__skill">«Системы газоснабжения»</p>
                    <p class="expert__attestat">аттестат № МС-Э-8-15-11772, <br>срок окончания — 15.03.2025</p>
                </article>
                <article class="expert">
                    <p class="expert__name">Русаченко Наталья Михайловна</p>
                    <p class="expert__skill">Квалификация по программе «Инженер по проектно-сметной работе (сметчик)»</p>
                    <p class="expert__attestat">Удостоверение (Документ о квалификации №2597) от 28.07.2017</p>
                </article>
            </div>
        </section>
